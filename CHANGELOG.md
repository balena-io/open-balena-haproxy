...
* Cli: Add parameter for bob modifications [Michael Angelos Simos]
* RestructureConfig: Add tests [Michael Angelos Simos]
* RestructureConfig: Add uuid injection [Michael Angelos Simos]
